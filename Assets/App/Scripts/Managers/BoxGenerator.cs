...
namespace DynamicBox.Managers
{
	public class BoxGenerator : MonoBehaviour
	{
		...
		public void CreateBox (float _width, float _height, float _depth /*, Transform[] touchPoints*/)
		{
			GameObject box = CreateBoxGameObject (_width, _height, _depth);
		...
		private void GenerateInstanceID (GameObject box)
		{
			...
			for (int i = 0; i < 13; i++)
			{
				s = string.Concat (s, (random.Next (9) + 1).ToString ());
			}

			double generatedID = double.Parse (s);
